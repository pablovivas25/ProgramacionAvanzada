...
public class EjercicioOIA {
	...
	public static void main(String[] args) {
		...
		ejercicio.leer("src/unlam/progava/oia/in/caso03.in");
		ejercicio.resolver();
		ejercicio.escribir("src/unlam/progava/oia/expected/caso03.out");
	}
	...
	public void leer(String path) {
		deposito = LectorDeArchivo.leer(path);
	}
	...
	public void escribir(String path) {
		EscritorDeArchivos.escribir(path, deposito.getResultado());
	}
